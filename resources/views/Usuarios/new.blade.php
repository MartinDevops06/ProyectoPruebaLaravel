...
@section('content')
<h3 class="mt-4 mb-3">Registro Usuarios</h3>
<form action="{{ url('usuarios') }}" method="POST">
    ...
    <div class="row">
        <div class="col-md-4">
            <input type="text" name="correo" class="form-control" placeholder="Ingrese correo" value="{{ old('correo') }}">
            @error('correo')
                <div class="error compacto col-lg-5">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <input type="text" name="DocumentoId" class="form-control" placeholder="Ingrese Documento de Identidad" value="{{ old('DocumentoId') }}">
            @error('DocumentoId')
                <div class="error compacto col-lg-5">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <input type="text" name="password" class="form-control" placeholder="Ingrese contraseña" value="{{ old('password') }}">
            @error('password')
                <div class="error compacto col-lg-5">{{ $message }}</div>
            @enderror
        </div>
